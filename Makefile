...
a.out: assignment.o date_time.o main.cc
	$(CC) $(CFLAGS) $^ -o $@
...
tests: run_tests
run_test: run_tests
run_tests: assignment.o date_time.o _TEST/TEST_cases.cc
...
debug: gdb.out
	gdb ./gdb.out
gdb.out: assignment.o date_time.o main.cc
	$(CC) $(CDFLAGS) $^ -o $@

#note: this test requires the installation of valgrind
valgrind: assignment.o date_time.o _TEST/TEST_cases.cc
